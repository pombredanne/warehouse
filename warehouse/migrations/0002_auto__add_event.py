...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Event'
        db.create_table('warehouse_event', (
            ...
            ('data', self.gf('django_hstore.fields.DictionaryField')(default={}, db_index=True, blank=True)),
        ))
        db.send_create_signal('warehouse', ['Event'])


    def backwards(self, orm):
        # Deleting model 'Event'
        db.delete_table('warehouse_event')
    ...
    models = {
        ...
        'warehouse.event': {
            ...
            'data': ('django_hstore.fields.DictionaryField', [], {'default': '{}', 'db_index': 'True', 'blank': 'True'}),
