...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'VersionFile', fields ['filename']
        db.create_unique('warehouse_versionfile', ['filename'])


    def backwards(self, orm):
        # Removing unique constraint on 'VersionFile', fields ['filename']
        db.delete_unique('warehouse_versionfile', ['filename'])
