...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Download.project'
        db.alter_column('warehouse_download', 'project', self.gf('django.db.models.fields.CharField')(max_length=512))

        # Changing field 'Download.filename'
        db.alter_column('warehouse_download', 'filename', self.gf('django.db.models.fields.CharField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'Download.project'
        db.alter_column('warehouse_download', 'project', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'Download.filename'
        db.alter_column('warehouse_download', 'filename', self.gf('django.db.models.fields.CharField')(max_length=500))
