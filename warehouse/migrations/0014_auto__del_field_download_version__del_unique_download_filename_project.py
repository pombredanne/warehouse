...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Download.version'
        db.delete_column('warehouse_download', 'version')
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'Download', fields ['date', 'project', 'filename', 'user_agent', 'label']
        db.delete_unique('warehouse_download', ['date', 'project', 'filename', 'user_agent_id', 'label'])

        # User chose to not deal with backwards NULL issues for 'Download.version'
        raise RuntimeError("Cannot reverse this migration. 'Download.version' and its values cannot be restored.")
