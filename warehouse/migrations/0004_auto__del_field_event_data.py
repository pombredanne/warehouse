...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('warehouse_event', 'data')


    def backwards(self, orm):
        # Adding field 'Event.data'
        db.add_column('warehouse_event', 'data',
                      self.gf('django_hstore.fields.DictionaryField')(default={}, blank=True, db_index=True),
                      keep_default=False)
