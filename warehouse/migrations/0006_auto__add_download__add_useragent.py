...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('warehouse_useragent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('agent', self.gf('django.db.models.fields.TextField')(unique=True)),
        ))
        db.send_create_signal('warehouse', ['UserAgent'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('warehouse_useragent')
