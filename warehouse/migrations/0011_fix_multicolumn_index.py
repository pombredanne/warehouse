...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Download', fields ['project', 'version', 'filename', 'user_agent', 'date', 'label']
        db.create_unique('warehouse_download', ['project', 'version', 'filename', 'user_agent_id', 'date', 'label'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Download', fields ['project', 'version', 'filename', 'user_agent', 'date', 'label']
        db.create_unique('warehouse_download', ['project', 'version', 'filename', 'user_agent_id', 'date', 'label'])
