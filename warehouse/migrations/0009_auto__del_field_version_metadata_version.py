...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Version.metadata_version'
        db.delete_column('warehouse_version', 'metadata_version')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Version.metadata_version'
        raise RuntimeError("Cannot reverse this migration. 'Version.metadata_version' and its values cannot be restored.")
