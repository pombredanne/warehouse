...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Download', fields ['label', 'date', 'project', 'filename', 'user_agent']
        db.delete_unique('warehouse_download', ['label', 'date', 'project', 'filename', 'user_agent_id'])
    ...
    def backwards(self, orm):
        ...
        db.create_table('warehouse_download', (
            ...
            ('id', self.gf('uuidfield.fields.UUIDField')(max_length=32, unique=True, primary_key=True)),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=512)),
        ))
        db.send_create_signal('warehouse', ['Download'])

        # Adding unique constraint on 'Download', fields ['label', 'date', 'project', 'filename', 'user_agent']
        db.create_unique('warehouse_download', ['label', 'date', 'project', 'filename', 'user_agent_id'])
